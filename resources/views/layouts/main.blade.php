...
<html lang="en">
  ...
  <head>
    ...
    <!-- Favicons-->
    <link rel="icon" href="{{url('/')}}/admin/images/favicon/favicon-32x32.png" sizes="32x32">
    <!-- Favicons-->
    <link rel="apple-touch-icon-precomposed" href="{{url('/')}}/admin/images/favicon/apple-touch-icon-152x152.png">
    <!-- For iPhone -->
    <meta name="msapplication-TileColor" content="#00bcd4">
    <meta name="msapplication-TileImage" content="{{url('/')}}/admin/images/favicon/mstile-144x144.png">
    <!-- For Windows Phone -->
    <!-- CORE CSS-->
    <link href="{{url('/')}}/admin/css//materialize.css" type="text/css" rel="stylesheet">
    <link href="{{url('/')}}/admin/css//style.css" type="text/css" rel="stylesheet">
    <!-- Custome CSS-->
    <link href="{{url('/')}}/admin/css/custom/custom.css" type="text/css" rel="stylesheet">
    <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
    <link href="{{url('/')}}/admin/vendors/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet">
    <link href="{{url('/')}}/admin/vendors/flag-icon/css/flag-icon.min.css" type="text/css" rel="stylesheet">
  </head>
  <body>
    <!-- Start Page Loading -->
            ...
            <ul class="left">
              <li>
                <h1 class="logo-wrapper">
                  <a href="{{url('/')}}/admin/index.html" class="brand-logo darken-1">
                    <img src="{{url('/')}}/admin/images/logo/materialize-logo.png" alt="materialize logo">
              ...
              <li>
                <a href="javascript:void(0);" class="waves-effect waves-block waves-light profile-button" data-activates="profile-dropdown">
                  <span class="avatar-status avatar-online">
                    <img src="{{url('/')}}/admin/images/avatar/avatar-7.png" alt="avatar">
                    <i></i>
                  </span>
                </a>
              </li>
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details cyan darken-2">
              <div class="row">
                <div class="col col s4 m4 l4">
                  <img src="{{url('/')}}/admin/images/avatar/avatar-7.png" alt="" class="circle responsive-img valign profile-image cyan">
                </div>
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                <li class="bold">
                  <a href="{{url('/')}}/admin/index.html" class="waves-effect waves-cyan">
                      <i class="material-icons">pie_chart_outlined</i>
                      <span class="nav-text">Dashboard</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="{{url('/')}}/admin/cards-basic.html" class="waves-effect waves-cyan">
                      <i class="material-icons">cast</i>
                      <span class="nav-text">Cards</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="{{url('/')}}/admin/ui-basic-buttons.html" class="waves-effect waves-cyan">
                      <i class="material-icons">insert_link</i>
                      <span class="nav-text">Buttons</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="blank" class="waves-effect waves-cyan">
                      <i class="material-icons">format_color_text</i>
                      <span class="nav-text">Forms</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="{{url('/')}}/admin/css-typography.html" class="waves-effect waves-cyan">
                      <i class="material-icons">format_size</i>
                      <span class="nav-text">Typography</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="{{url('/')}}/admin/css-color.html" class="waves-effect waves-cyan">
                      <i class="material-icons">invert_colors</i>
                      <span class="nav-text">Color</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="blank2" class="waves-effect waves-cyan">
                      <i class="material-icons">border_all</i>
                      <span class="nav-text">Table</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="{{url('/')}}/admin/ui-icons.html" class="waves-effect waves-cyan">
                ...
                <div id="chatapp" class="col s12">
                  <div class="collection border-none">
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-1.png" alt="" class="circle cyan">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-2.png" alt="" class="circle deep-orange accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-3.png" alt="" class="circle teal accent-4">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-4.png" alt="" class="circle cyan">
                      <span class="line-height-0">June Lane </span>
                      <span class="medium-small right blue-grey-text text-lighten-3">4.14 AM</span>
                      <p class="medium-small blue-grey-text text-lighten-3">Ohh God </p>
                    </a>
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-5.png" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-6.png" alt="" class="circle deep-orange accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-7.png" alt="" class="circle cyan">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-8.png" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-9.png" alt="" class="circle teal accent-4">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-2.png" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-4.png" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{url('/')}}/admin/images/avatar/avatar-5.png" alt="" class="circle cyan">
    ...
    ================================================ -->
    <!-- jQuery Library -->
    <script type="text/javascript" src="{{url('/')}}/admin/vendors/jquery-3.2.1.min.js"></script>
    <!--materialize js-->
    <script type="text/javascript" src="{{url('/')}}/admin/js/materialize.min.js"></script>
    <!--scrollbar-->
    <script type="text/javascript" src="{{url('/')}}/admin/vendors/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <!--plugins.js - Some Specific JS codes for Plugin Settings-->
    <script type="text/javascript" src="{{url('/')}}/admin/js/plugins.js"></script>
    <!--custom-script.js - Add your own theme custom JS-->
    <script type="text/javascript" src="{{url('/')}}/admin/js/custom-script.js"></script>
  </body>
</html>